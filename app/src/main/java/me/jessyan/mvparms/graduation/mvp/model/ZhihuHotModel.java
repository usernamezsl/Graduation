...
@ActivityScope
public class ZhihuHotModel extends BaseModel<ServiceManager, CacheManager> implements ZhihuHotContract.Model {
    private Gson mGson;
    private Application mApplication;

    @Inject
    public ZhihuHotModel(ServiceManager serviceManager, CacheManager cacheManager, Gson gson, Application application) {
    ...
    @Override
    public Observable<SectionChildListBean> getXiacheData(int id) {
        ...
        return mCacheManager.getZhihuCache()
                .getXiaCheData(sectionChildList)
