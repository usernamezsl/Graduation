...
import me.jessyan.mvparms.graduation.mvp.model.AskModel;
...
public class AskModule {
    ...
    /**
     * 构建AskModule时,将View的实现类传进来,这样就可以提供View的实现类给presenter
     * @param view
     */
    ...
    @ActivityScope
    @Provides
    AskContract.View provideAskView() {
        return this.view;
    }

    @ActivityScope
    @Provides
    AskContract.Model provideAskModel(AskModel model) {
        return model;
    }
}