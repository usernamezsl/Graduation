...
@ActivityScope
public class HotModel extends BaseModel<ServiceManager, CacheManager> implements HotContract.Model {
    private Gson mGson;
    private Application mApplication;

    @Inject
    public HotModel(ServiceManager serviceManager, CacheManager cacheManager, Gson gson, Application application) {
    ...
    @Override
    public Observable<GankItemBean> getMeizhiData(int num) {
        Observable<GankItemBean> meizhi = mServiceManager.getCommonService()
                .getMeizhi(num);
    ...
    @Override
    public Observable<HotContentBean> getHotContent() {
