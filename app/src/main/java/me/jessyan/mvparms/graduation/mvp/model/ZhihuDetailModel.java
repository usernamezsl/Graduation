...
@ActivityScope
public class ZhihuDetailModel extends BaseModel<ServiceManager, CacheManager> implements ZhihuDetailContract.Model {
    private Gson mGson;
    private Application mApplication;

    @Inject
    public ZhihuDetailModel(ServiceManager serviceManager, CacheManager cacheManager, Gson gson, Application application) {
    ...
    public Observable<ZhihuDetailBean> getZhihuDetail(int id) {
        return mServiceManager.getZhihuService()
                .getZhihuDetail(id);
    }
}