...
import me.jessyan.mvparms.graduation.di.component.DaggerUniversitityComponent;
import me.jessyan.mvparms.graduation.di.module.UniversitityModule;
import me.jessyan.mvparms.graduation.mvp.contract.UniversitityContract;
...
import me.jessyan.mvparms.graduation.mvp.presenter.UniversitityPresenter;
...
public class UniversitityFragment extends WEFragment<UniversitityPresenter> implements UniversitityContract.View {
    ...
    public static UniversitityFragment newInstance() {
        UniversitityFragment fragment = new UniversitityFragment();
        return fragment;
    }

    @Override
    protected void setupFragmentComponent(AppComponent appComponent) {
        DaggerUniversitityComponent
                .builder()
                .appComponent(appComponent)
                .universitityModule(new UniversitityModule(this))//请将UniversitityModule()第一个首字母改为小写
                .build()
                .inject(this);
    }
    ...
    protected View initView() {
        return LayoutInflater.from(getActivity()).inflate(R.layout.fragment_university_view, null, false);
    }
    ...
    protected void onEnterAnimationEnd(Bundle savedInstanceState) {
        ...
        mPresenter.getUniversityData(37);
