...
@ActivityScope
public class MidNightModel extends BaseModel<ServiceManager, CacheManager> implements MidNightContract.Model {
    private Gson mGson;
    private Application mApplication;

    @Inject
    public MidNightModel(ServiceManager serviceManager, CacheManager cacheManager, Gson gson, Application application) {
    ...
    @Override
    public Observable<SectionChildListBean> getMidNightData(int id) {
        ...
        return mCacheManager.getZhihuCache()
                .getSectionChildList(sectionChildList)
