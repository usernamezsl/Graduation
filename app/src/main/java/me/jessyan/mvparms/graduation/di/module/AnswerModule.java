...
import me.jessyan.mvparms.graduation.mvp.model.AnswerModel;
...
public class AnswerModule {
    ...
    /**
     * 构建AnswerModule时,将View的实现类传进来,这样就可以提供View的实现类给presenter
     * @param view
     */
    ...
    @ActivityScope
    @Provides
    AnswerContract.View provideAnswerView() {
        return this.view;
    }

    @ActivityScope
    @Provides
    AnswerContract.Model provideAnswerModel(AnswerModel model) {
        return model;
    }
}