...
@ActivityScope
public class IosModel extends BaseModel<ServiceManager, CacheManager> implements IosContract.Model {
    private Gson mGson;
    private Application mApplication;

    @Inject
    public IosModel(ServiceManager serviceManager, CacheManager cacheManager, Gson gson, Application application) {
