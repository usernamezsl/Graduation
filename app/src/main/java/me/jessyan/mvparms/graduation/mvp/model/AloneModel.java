...
@ActivityScope
public class AloneModel extends BaseModel<ServiceManager, CacheManager> implements AloneContract.Model {
    private Gson mGson;
    private Application mApplication;

    @Inject
    public AloneModel(ServiceManager serviceManager, CacheManager cacheManager, Gson gson, Application application) {
    ...
    @Override
    public Observable<SectionChildListBean> getAloneData(int id) {
