...
@ActivityScope
public class UniversitityModel extends BaseModel<ServiceManager, CacheManager> implements UniversitityContract.Model {
    private Gson mGson;
    private Application mApplication;

    @Inject
    public UniversitityModel(ServiceManager serviceManager, CacheManager cacheManager, Gson gson, Application application) {
    ...
    @Override
    public Observable<SectionChildListBean> getUnivertityData(int id) {
        Observable<SectionChildListBean> sectionChildList = mServiceManager.getZhihuService()
                .getSectionChildList(id);
        return mCacheManager.getZhihuCache()
                .getUniversity(sectionChildList)
