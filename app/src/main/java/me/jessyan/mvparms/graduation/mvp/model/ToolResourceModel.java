...
@ActivityScope
public class ToolResourceModel extends BaseModel<ServiceManager, CacheManager> implements ToolResourceContract.Model {
    private Gson mGson;
    private Application mApplication;

    @Inject
    public ToolResourceModel(ServiceManager serviceManager, CacheManager cacheManager, Gson gson, Application application) {
