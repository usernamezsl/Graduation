...
@ActivityScope
public class JobPresenter extends BasePresenter<JobContract.Model, JobContract.View> {
    ...
    @Inject
    public JobPresenter(JobContract.Model model, JobContract.View rootView
    ...
    public void getJobData(int id){
        mModel.getJobData(id)
