...
public interface MeizhiContract {
    ...
    interface View extends BaseView {
        ...
        void showMeizhiWithDesc(List<MeizhiWithVideo> meizhiWithVideos);
    }
    ...
    interface Model extends IModel {
         ...
         * @return
         */
        Observable<GankItemBean> getMeizhi(int num);


        Observable<GankHttpResponse<List<GanHuoDataBean>>> getMeizhiDesc(int page);
