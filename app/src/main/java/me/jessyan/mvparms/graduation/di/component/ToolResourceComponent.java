...
@ActivityScope
@Component(modules = ToolResourceModule.class, dependencies = AppComponent.class)
public interface ToolResourceComponent {
    void inject(ToolResourceFragment toolResourceFragment);
}