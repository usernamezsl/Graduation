...
@ActivityScope
public class SignupModel extends BaseModel<ServiceManager, CacheManager> implements SignupContract.Model {
    private Gson mGson;
    private Application mApplication;

    @Inject
    public SignupModel(ServiceManager serviceManager, CacheManager cacheManager, Gson gson, Application application) {
