...
import me.jessyan.mvparms.graduation.di.component.DaggerAdwareComponent;
import me.jessyan.mvparms.graduation.di.module.AdwareModule;
import me.jessyan.mvparms.graduation.mvp.contract.AdwareContract;
...
import me.jessyan.mvparms.graduation.mvp.presenter.AdwarePresenter;
...
public class AdwareFragment extends WEFragment<AdwarePresenter> implements AdwareContract.View {
    ...
    Toolbar mToolbar;
    @BindView(R.id.rv_adware_content)
    RecyclerView mRvAdwareContent;
    ...
    public static AdwareFragment newInstance() {
    ...
    protected void setupFragmentComponent(AppComponent appComponent) {
        DaggerAdwareComponent
                .builder()
                .appComponent(appComponent)
                .adwareModule(new AdwareModule(this))//请将AdwareModule()第一个首字母改为小写
                .build()
                .inject(this);
    }
    ...
    protected View initView() {
        return LayoutInflater.from(getActivity()).inflate(R.layout.fragment_adware_view, null, false);
    }
    ...
    protected void onEnterAnimationEnd(Bundle savedInstanceState) {
        ...
        mRvAdwareContent.setVisibility(View.INVISIBLE);
        mRvAdwareContent.setLayoutManager(new LinearLayoutManager(_mActivity));
        mRvAdwareContent.setHasFixedSize(true);
        mRvAdwareContent.setAdapter(mSectionChildAdapter);
        mPresenter.getAdwareData(19);
    ...
    public void showContent(SectionChildListBean sectionChildListBean) {
        ...
        mRvAdwareContent.setVisibility(View.VISIBLE);
        mList.clear();
