...
import me.jessyan.mvparms.graduation.di.component.DaggerAloneComponent;
import me.jessyan.mvparms.graduation.di.module.AloneModule;
...
import me.jessyan.mvparms.graduation.mvp.presenter.AlonePresenter;
...
public class AloneFragment extends WEFragment<AlonePresenter> implements AloneContract.View {
    ...
    protected void setupFragmentComponent(AppComponent appComponent) {
        DaggerAloneComponent
                .builder()
                .appComponent(appComponent)
                .aloneModule(new AloneModule(this))//请将AloneModule()第一个首字母改为小写
                .build()
                .inject(this);
    }
    ...
    protected View initView() {
        return LayoutInflater.from(getActivity()).inflate(R.layout.fragment_alone_view, null, false);
    }
