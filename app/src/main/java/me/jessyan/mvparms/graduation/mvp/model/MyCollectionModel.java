...
@ActivityScope
public class MyCollectionModel extends BaseModel<ServiceManager, CacheManager> implements MyCollectionContract.Model {
    private Gson mGson;
    private Application mApplication;

    @Inject
    public MyCollectionModel(ServiceManager serviceManager, CacheManager cacheManager, Gson gson, Application application) {
