...
@ActivityScope
public class WriteArticleModel extends BaseModel<ServiceManager, CacheManager> implements WriteArticleContract.Model {
    private Gson mGson;
    private Application mApplication;

    @Inject
    public WriteArticleModel(ServiceManager serviceManager, CacheManager cacheManager, Gson gson, Application application) {
