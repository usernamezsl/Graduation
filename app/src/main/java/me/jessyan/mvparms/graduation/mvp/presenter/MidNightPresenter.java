...
@ActivityScope
public class MidNightPresenter extends BasePresenter<MidNightContract.Model, MidNightContract.View> {
    private RxErrorHandler mErrorHandler;
    private Application mApplication;
    private ImageLoader mImageLoader;
    private AppManager mAppManager;
    private SectionChildListBean mSectionChildListBean;

    @Inject
    public MidNightPresenter(MidNightContract.Model model, MidNightContract.View rootView
     ...
     * @param id
     */
    public void getMidNightData(int id) {
        mModel.getMidNightData(id)
                ...
                .subscribe(new Action1<SectionChildListBean>() {
                    ...
                    public void call(SectionChildListBean sectionChildListBean) {
                        mSectionChildListBean = sectionChildListBean;
                        mRootView.showContent(mSectionChildListBean);
                    }
