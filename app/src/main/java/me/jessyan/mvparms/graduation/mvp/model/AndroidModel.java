...
@ActivityScope
public class AndroidModel extends BaseModel<ServiceManager, CacheManager> implements AndroidContract.Model {
    private Gson mGson;
    private Application mApplication;

    @Inject
    public AndroidModel(ServiceManager serviceManager, CacheManager cacheManager, Gson gson, Application application) {
    ...
    @Override
    public Observable<GankTechBean> getAndroidData(String tech, int num, int page) {
    ...
    @Override
    public Observable<GankHttpResponse<List<GanHuoDataBean>>> getData(int page) {
