...
@ActivityScope
public class AnswerModel extends BaseModel<ServiceManager, CacheManager> implements AnswerContract.Model {
    private Gson mGson;
    private Application mApplication;

    @Inject
    public AnswerModel(ServiceManager serviceManager, CacheManager cacheManager, Gson gson, Application application) {
