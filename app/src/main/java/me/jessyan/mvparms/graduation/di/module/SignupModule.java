...
import me.jessyan.mvparms.graduation.mvp.model.SignupModel;
...
public class SignupModule {
    ...
    /**
     * 构建SignupModule时,将View的实现类传进来,这样就可以提供View的实现类给presenter
     * @param view
     */
    ...
    @ActivityScope
    @Provides
    SignupContract.Model provideSignupModel(SignupModel model) {
        return model;
    }
}