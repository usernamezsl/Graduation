...
@ActivityScope
public class AskModel extends BaseModel<ServiceManager, CacheManager> implements AskContract.Model {
    private Gson mGson;
    private Application mApplication;

    @Inject
    public AskModel(ServiceManager serviceManager, CacheManager cacheManager, Gson gson, Application application) {
