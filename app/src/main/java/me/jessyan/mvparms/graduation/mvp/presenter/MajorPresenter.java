...
@ActivityScope
public class MajorPresenter extends BasePresenter<MajorContract.Model, MajorContract.View> {
    ...
    @Inject
    public MajorPresenter(MajorContract.Model model, MajorContract.View rootView
    ...
    public void getMajorData(int id) {
        mModel.getMajorData(id)
