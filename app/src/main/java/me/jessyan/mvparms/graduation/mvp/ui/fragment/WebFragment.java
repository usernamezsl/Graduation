...
import me.jessyan.mvparms.graduation.di.component.DaggerWebComponent;
import me.jessyan.mvparms.graduation.di.module.WebModule;
...
import me.jessyan.mvparms.graduation.mvp.presenter.WebPresenter;
...
public class WebFragment extends WEFragment<WebPresenter> implements WebContract.View {
    ...
    Toolbar mToolbar;
    @BindView(R.id.rv_web_list)
    RecyclerView mRvWebList;
    ...
    protected View initView() {
        return LayoutInflater.from(getActivity()).inflate(R.layout.fragment_web_view, null, false);
    }
    ...
    protected void onEnterAnimationEnd(Bundle savedInstanceState) {
        ...
        mRvWebList.setVisibility(View.INVISIBLE);
        mRvWebList.setLayoutManager(new LinearLayoutManager(_mActivity));
        mRvWebList.setHasFixedSize(true);
        mRvWebList.setAdapter(mAdapter);
        mPresenter.getWebData("前端", 20, 0);
    ...
    public void showContent(List<GankTechBean.ResultsBean> resultsBeen) {
        hideLoading();
        mRvWebList.setVisibility(View.VISIBLE);
        mList.clear();
