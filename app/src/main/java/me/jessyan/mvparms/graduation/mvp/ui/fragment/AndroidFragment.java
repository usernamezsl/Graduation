...
import me.jessyan.mvparms.graduation.di.component.DaggerAndroidComponent;
import me.jessyan.mvparms.graduation.di.module.AndroidModule;
...
import me.jessyan.mvparms.graduation.mvp.presenter.AndroidPresenter;
...
public class AndroidFragment extends WEFragment<AndroidPresenter> implements AndroidContract.View {
    ...
    protected void setupFragmentComponent(AppComponent appComponent) {
        DaggerAndroidComponent
                ...
                .androidModule(new AndroidModule(this))//请将AndroidModule()第一个首字母改为小写
                .build()
                .inject(this);
    }
    ...
    protected View initView() {
        return LayoutInflater.from(getActivity()).inflate(R.layout.fragment_android_view, null, false);
    }
    ...
    @Override
    public void showData(List<GanHuoDataBean> ganHuoDataBeen) {
