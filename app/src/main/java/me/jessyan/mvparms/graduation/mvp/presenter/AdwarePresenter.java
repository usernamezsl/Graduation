...
@ActivityScope
public class AdwarePresenter extends BasePresenter<AdwareContract.Model, AdwareContract.View> {
    ...
    @Inject
    public AdwarePresenter(AdwareContract.Model model, AdwareContract.View rootView
    ...
    public void getAdwareData(int id) {
        mModel.getAdware(id)
