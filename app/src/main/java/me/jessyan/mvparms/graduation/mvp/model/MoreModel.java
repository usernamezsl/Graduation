...
@ActivityScope
public class MoreModel extends BaseModel<ServiceManager, CacheManager> implements MoreContract.Model {
    private Gson mGson;
    private Application mApplication;

    @Inject
    public MoreModel(ServiceManager serviceManager, CacheManager cacheManager, Gson gson, Application application) {
