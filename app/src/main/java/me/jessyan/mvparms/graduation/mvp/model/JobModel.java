...
@ActivityScope
public class JobModel extends BaseModel<ServiceManager, CacheManager> implements JobContract.Model {
    private Gson mGson;
    private Application mApplication;

    @Inject
    public JobModel(ServiceManager serviceManager, CacheManager cacheManager, Gson gson, Application application) {
    ...
    @Override
    public Observable<SectionChildListBean> getJobData(int id) {
