...
import me.jessyan.mvparms.graduation.di.component.DaggerIosComponent;
import me.jessyan.mvparms.graduation.di.module.IosModule;
...
import me.jessyan.mvparms.graduation.mvp.presenter.IosPresenter;
...
public class IosFragment extends WEFragment<IosPresenter> implements IosContract.View {
    ...
    protected void setupFragmentComponent(AppComponent appComponent) {
        DaggerIosComponent
                ...
                .iosModule(new IosModule(this))//请将IosModule()第一个首字母改为小写
                .build()
                .inject(this);
    }
    ...
    protected View initView() {
        return LayoutInflater.from(getActivity()).inflate(R.layout.fragment_ios_view, null, false);
    }
