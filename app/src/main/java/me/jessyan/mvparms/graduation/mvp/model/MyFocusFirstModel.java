...
@ActivityScope
public class MyFocusFirstModel extends BaseModel<ServiceManager, CacheManager> implements MyFocusFirstContract.Model {
    private Gson mGson;
    private Application mApplication;

    @Inject
    public MyFocusFirstModel(ServiceManager serviceManager, CacheManager cacheManager, Gson gson, Application application) {
