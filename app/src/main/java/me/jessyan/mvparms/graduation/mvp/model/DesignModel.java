...
@ActivityScope
public class DesignModel extends BaseModel<ServiceManager, CacheManager> implements DesignContract.Model {
    private Gson mGson;
    private Application mApplication;

    @Inject
    public DesignModel(ServiceManager serviceManager, CacheManager cacheManager, Gson gson, Application application) {
