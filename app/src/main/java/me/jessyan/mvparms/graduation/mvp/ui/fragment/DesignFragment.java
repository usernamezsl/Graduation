...
import me.jessyan.mvparms.graduation.di.component.DaggerDesignComponent;
...
import me.jessyan.mvparms.graduation.mvp.presenter.DesignPresenter;
...
public class DesignFragment extends WEFragment<DesignPresenter> implements DesignContract.View {
    ...
    protected void setupFragmentComponent(AppComponent appComponent) {
        DaggerDesignComponent
                .builder()
                .appComponent(appComponent)
                .designModule(new DesignModule(this))//请将DesignModule()第一个首字母改为小写
                .build()
                .inject(this);
    }
    ...
    protected View initView() {
        return LayoutInflater.from(getActivity()).inflate(R.layout.fragment_design_view, null, false);
    }
