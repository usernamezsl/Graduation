...
import me.jessyan.mvparms.graduation.di.component.DaggerMyFocusThirdComponent;
import me.jessyan.mvparms.graduation.di.module.MyFocusThirdModule;
...
import me.jessyan.mvparms.graduation.mvp.presenter.MyFocusThirdPresenter;
...
public class MyFocusThirdFragment extends WEFragment<MyFocusThirdPresenter> implements MyFocusThirdContract.View {
    ...
    public static MyFocusThirdFragment newInstance() {
        MyFocusThirdFragment fragment = new MyFocusThirdFragment();
        return fragment;
    }

    @Override
    protected void setupFragmentComponent(AppComponent appComponent) {
        DaggerMyFocusThirdComponent
                .builder()
                .appComponent(appComponent)
                .myFocusThirdModule(new MyFocusThirdModule(this))//请将MyFocusThirdModule()第一个首字母改为小写
                .build()
                .inject(this);
    }
    ...
    protected View initView() {
        return LayoutInflater.from(getActivity()).inflate(R.layout.fragment_myfocus_third, null, false);
    }
    ...
    protected void onEnterAnimationEnd(Bundle savedInstanceState) {
        ...
        mPresenter.getWebData("iOS", 20, 0);
