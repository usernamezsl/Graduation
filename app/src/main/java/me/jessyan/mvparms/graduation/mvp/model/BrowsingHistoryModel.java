...
@ActivityScope
public class BrowsingHistoryModel extends BaseModel<ServiceManager, CacheManager> implements BrowsingHistoryContract.Model {
    private Gson mGson;
    private Application mApplication;

    @Inject
    public BrowsingHistoryModel(ServiceManager serviceManager, CacheManager cacheManager, Gson gson, Application application) {
