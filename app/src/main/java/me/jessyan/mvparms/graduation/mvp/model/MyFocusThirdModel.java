...
@ActivityScope
public class MyFocusThirdModel extends BaseModel<ServiceManager, CacheManager> implements MyFocusThirdContract.Model {
    private Gson mGson;
    private Application mApplication;

    @Inject
    public MyFocusThirdModel(ServiceManager serviceManager, CacheManager cacheManager, Gson gson, Application application) {
