...
import me.jessyan.mvparms.graduation.di.component.DaggerMyFocusSecondComponent;
import me.jessyan.mvparms.graduation.di.module.MyFocusSecondModule;
...
import me.jessyan.mvparms.graduation.mvp.presenter.MyFocusSecondPresenter;
...
public class MyFocusSecondFragment extends WEFragment<MyFocusSecondPresenter> implements MyFocusSecondContract.View {
    ...
    public static MyFocusSecondFragment newInstance() {
        MyFocusSecondFragment fragment = new MyFocusSecondFragment();
        return fragment;
    }

    @Override
    protected void setupFragmentComponent(AppComponent appComponent) {
        DaggerMyFocusSecondComponent
                .builder()
                .appComponent(appComponent)
                .myFocusSecondModule(new MyFocusSecondModule(this))//请将MyFocusSecondModule()第一个首字母改为小写
                .build()
                .inject(this);
    }
    ...
    protected View initView() {
        return LayoutInflater.from(getActivity()).inflate(R.layout.fragment_myfocus_second, null, false);
    }
    ...
    protected void onEnterAnimationEnd(Bundle savedInstanceState) {
        ...
        mPresenter.getIosData("iOS", 20, 0);
