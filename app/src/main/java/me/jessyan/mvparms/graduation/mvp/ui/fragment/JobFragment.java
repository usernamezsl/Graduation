...
import me.jessyan.mvparms.graduation.di.component.DaggerJobComponent;
import me.jessyan.mvparms.graduation.di.module.JobModule;
import me.jessyan.mvparms.graduation.mvp.contract.JobContract;
...
import me.jessyan.mvparms.graduation.mvp.presenter.JobPresenter;
...
public class JobFragment extends WEFragment<JobPresenter> implements JobContract.View {
    ...
    protected void setupFragmentComponent(AppComponent appComponent) {
        DaggerJobComponent
                ...
                .jobModule(new JobModule(this))//请将JobModule()第一个首字母改为小写
                .build()
                .inject(this);
    }
    ...
    protected View initView() {
        return LayoutInflater.from(getActivity()).inflate(R.layout.fragment_job_view, null, false);
    }
