...
@ActivityScope
public class ZhihuHotPresenter extends BasePresenter<ZhihuHotContract.Model, ZhihuHotContract.View> {
    ...
    @Inject
    public ZhihuHotPresenter(ZhihuHotContract.Model model, ZhihuHotContract.View rootView
     ...
     * 请求数据
     */
    public void requestZhihuHotData(int id) {
        mModel.getXiacheData(id)
