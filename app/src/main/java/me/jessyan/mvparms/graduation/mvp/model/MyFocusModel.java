...
@ActivityScope
public class MyFocusModel extends BaseModel<ServiceManager, CacheManager> implements MyFocusContract.Model {
    private Gson mGson;
    private Application mApplication;

    @Inject
    public MyFocusModel(ServiceManager serviceManager, CacheManager cacheManager, Gson gson, Application application) {
