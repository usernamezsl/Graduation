...
@ActivityScope
public class MyFocusSecondModel extends BaseModel<ServiceManager, CacheManager> implements MyFocusSecondContract.Model {
    private Gson mGson;
    private Application mApplication;

    @Inject
    public MyFocusSecondModel(ServiceManager serviceManager, CacheManager cacheManager, Gson gson, Application application) {
    ...
    @Override
    public Observable<GankTechBean> getIosData(String tech, int num, int page) {
