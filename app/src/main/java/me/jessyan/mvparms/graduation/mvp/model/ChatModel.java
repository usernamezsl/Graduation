...
@ActivityScope
public class ChatModel extends BaseModel<ServiceManager, CacheManager> implements ChatContract.Model {
    private Gson mGson;
    private Application mApplication;

    @Inject
    public ChatModel(ServiceManager serviceManager, CacheManager cacheManager, Gson gson, Application application) {
