...
@ActivityScope
public class AdwareModel extends BaseModel<ServiceManager, CacheManager> implements AdwareContract.Model {
    private Gson mGson;
    private Application mApplication;

    @Inject
    public AdwareModel(ServiceManager serviceManager, CacheManager cacheManager, Gson gson, Application application) {
    ...
    @Override
    public Observable<SectionChildListBean> getAdware(int id) {
        ...
        return mCacheManager.getZhihuCache()
                .getAdawrewData(sectionChildList)
